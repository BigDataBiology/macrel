            ...
            <el-col :span="14">
                <div class="content">
                    ...
                    <div class="content-body">
                        ...
                        <p>The classifiers implemented in Macrel use random
                        forests and a short set of 22 descriptors to predict
                        AMPs with an accuracy above 96% and 100%. Macrel was
                        designed to find novel peptides in metagenomic samples,
                        an important resource of diversity. Please visit our
                        github webpage if you are interested in running it
                        locally.</p>
